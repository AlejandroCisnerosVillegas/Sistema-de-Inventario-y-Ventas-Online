<?php
    ...
    if (strlen($_SESSION['aid'] == 0)) {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($query) {
                echo "<script>alert('La compañía se registro con éxito.');</script>";
                ...
                <div class="hk-pg-wrapper">
                    <nav class="hk-breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-light bg-transparent">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Buscar factura</li>
                        </ol>
                    </nav>
                    <div class="container">
                        <div class="hk-pg-header">
                            <h4 class="hk-pg-title"><span class="pg-title-icon"></span>Buscar factura por fecha</h4>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
