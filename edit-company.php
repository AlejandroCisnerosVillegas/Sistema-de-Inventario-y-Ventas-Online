<?php
    ...
    if (strlen($_SESSION['aid'] == 0)) {
        ...
        if (isset($_POST['update'])) {
            ...
            $query = mysqli_query($con, "update  project_09_company set  CompanyName='$cname' where id='$cmpid'");
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"></span>Editar compañía</h4>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form class="needs-validation" method="post" novalidate>
                                            <?php
                                                $cmpid = substr(base64_decode($_GET['compid']), 0, -5);
                                                $query = mysqli_query($con, "select * from project_09_company where id='$cmpid' ");
                                                $cnt = 1;
