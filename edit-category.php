<?php
    ...
    if (strlen($_SESSION['aid'] == 0)) {
        ...
        if (isset($_POST['update'])) {
            ...
            $query = mysqli_query($con, "update project_09_category set CategoryName='$catname',CategoryCode='$catcode' where id='$cid'");
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"></span>Editar categoría</h4>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form class="needs-validation" method="post" novalidate>
                                            <?php
                                                $cid=substr(base64_decode($_GET['catid']),0,-5);
                                                $ret=mysqli_query($con,"select * from project_09_category where ID='$cid'");
                                                $cnt=1;
